...
elrond_total_num_validator_ignored_signatures_node3=
...
elrond_get() {
  ...
  elrond_current_round_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_current_round )"
  ...
  elrond_synced_round_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_synchronized_round )"
  ...
  elrond_node_type_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_node_type )"
  ...
  elrond_peer_type_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_peer_type )"
  ...
  elrond_shard_id_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_shard_id | head -c2 )"
  ...
  elrond_app_version_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_app_version | head -c10 )"
  ...
  elrond_epoch_number_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_epoch_number )"
  ...
  elrond_connected_peers_node3="$( curl -sSL http://localhost:8083/node/status | jq .data.metrics.erd_num_connected_peers )"
  ...
  elrond_connected_validators_node3="$( curl -sSL http://localhost:8083/node/heartbeatstatus | jq '.' | grep peerType | grep -c -v observer )"
  ...
  elrond_connected_nodes_node3="$( curl -sSL http://localhost:8083/node/status | jq .data.metrics.erd_connected_nodes )"
  ...
  elrond_bls_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_public_key_block_sign )"
  ...
  elrond_tempRating_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".tempRating' | head -c5 )"
  ...
  elrond_count_consensus_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_count_consensus )"
  ...
  elrond_count_consensus_accepted_blocks_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_count_consensus_accepted_blocks )"
  ...
  elrond_count_leader_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_count_leader )"
  ...
  elrond_count_accepted_blocks_node3="$( curl -sSL http://localhost:8083/node/status | jq -r .data.metrics.erd_count_accepted_blocks )"
  ...
  elrond_num_leader_success_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".numLeaderSuccess' )"
  ...
  elrond_num_leader_failure_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".numLeaderFailure' )"
  ...
  elrond_num_validator_success_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".numValidatorSuccess' )"
  ...
  elrond_num_validator_failure_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".numValidatorFailure' )"
  ...
  elrond_num_validator_ignored_signatures_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".numValidatorIgnoredSignatures' )"
  ...
  elrond_total_num_leader_success_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".totalNumLeaderSuccess' )"
  ...
  elrond_total_num_leader_failure_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".totalNumLeaderFailure' )"
  ...
  elrond_total_num_validator_success_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".totalNumValidatorSuccess' )"
  ...
  elrond_total_num_validator_failure_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".totalNumValidatorFailure' )"
  ...
  elrond_total_num_validator_ignored_signatures_node3="$( curl -sSL https://api.elrond.com/validator/statistics | jq '.data.statistics."'$elrond_bls_node3'".totalNumValidatorIgnoredSignatures' )"
...
DIMENSION current 'Current' absolute 1 1
DIMENSION synced 'Synced' absolute 1 1
CHART elrond.sync-node3 '' "$elrond_node_type_node3/$elrond_peer_type_node3 E:$elrond_epoch_number_node3 S:$elrond_shard_id_node3 P/V/N:$elrond_connected_peers_node3/$elrond_connected_validators_node3/$elrond_connected_nodes_node3 R:$elrond_tempRating_node3 $elrond_app_version_node3" "Round" "Consensus round" round line $((elrond_priority + 3)) $elrond_update_every
DIMENSION current 'Current' absolute 1 1
DIMENSION synced 'Synced' absolute 1 1
CHART elrond.validatorblocks-node0 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 4)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.validatorblocks-node1 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 5)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.validatorblocks-node2 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 6)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.validatorblocks-node3 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 7)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node0 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 8)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node1 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 9)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node2 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 10)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node3 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 11)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.rating-node0 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 12)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.rating-node1 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 13)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.rating-node2 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 14)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.rating-node3 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 15)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.epoch-node0 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 16)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.epoch-node1 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 17)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.epoch-node2 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 18)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.epoch-node3 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 19)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.peers-node0 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 20)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.peers-node1 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 21)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.peers-node2 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 22)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.peers-node3 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 23)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.validators_nodes-node0 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 24)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.validators_nodes-node1 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 25)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.validators_nodes-node2 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 26)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.validators_nodes-node3 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 27)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.num_leader-node0 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 28)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_leader-node1 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 29)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_leader-node2 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 30)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_leader-node3 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 31)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node0 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 32)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node1 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 33)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node2 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 34)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node3 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 35)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.ignored_signatures-node0 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 36)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.ignored_signatures-node1 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 37)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.ignored_signatures-node2 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 38)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.ignored_signatures-node3 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 39)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_num_leader-node0 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 40)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_leader-node1 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 41)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_leader-node2 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 42)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_leader-node3 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 43)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node0 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 44)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node1 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 45)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node2 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 46)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node3 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 47)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_ignored_signatures-node0 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 48)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_ignored_signatures-node1 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 49)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_ignored_signatures-node2 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 50)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_ignored_signatures-node3 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 51)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
EOF
...
END
BEGIN elrond.sync-node3 $1
SET current = $elrond_current_round_node3
SET synced = $elrond_synced_round_node3
END
...
END
BEGIN elrond.validatorblocks-node3 $1
SET signedblocks = $elrond_count_consensus_node3
SET signedaccepted = $elrond_count_consensus_accepted_blocks_node3
END
...
END
BEGIN elrond.leaderblocks-node3 $1
SET leaderproposed = $elrond_count_leader_node3
SET leaderaccepted = $elrond_count_accepted_blocks_node3
END
...
END
BEGIN elrond.rating-node3 $1
SET rating = $elrond_tempRating_node3
END
...
END
BEGIN elrond.epoch-node3 $1
SET epoch = $elrond_epoch_number_node3
END
...
END
BEGIN elrond.peers-node3 $1
SET peers = $elrond_connected_peers_node3
END
...
END
BEGIN elrond.validators_nodes-node3 $1
SET validators = $elrond_connected_validators_node3
SET nodes = $elrond_connected_nodes_node3
END
...
END
BEGIN elrond.num_leader-node3 $1
SET leader_success = $elrond_num_leader_success_node3
SET leader_failure = $elrond_num_leader_failure_node3
END
...
END
BEGIN elrond.num_validator-node3 $1
SET validator_success = $elrond_num_validator_success_node3
SET validator_failure = $elrond_num_validator_failure_node3
END
...
END
BEGIN elrond.ignored_signatures-node3 $1
SET validator_ignored_signatures = $elrond_num_validator_ignored_signatures_node3
END
...
END
BEGIN elrond.total_num_leader-node3 $1
SET total_leader_success = $elrond_total_num_leader_success_node3
SET total_leader_failure = $elrond_total_num_leader_failure_node3
END
...
END
BEGIN elrond.total_num_validator-node3 $1
SET total_validator_success = $elrond_total_num_validator_success_node3
SET total_validator_failure = $elrond_total_num_validator_failure_node3
END
...
END
BEGIN elrond.total_ignored_signatures-node3 $1
SET total_validator_ignored_signatures = $elrond_total_num_validator_ignored_signatures_node3
END
VALUESEOF
