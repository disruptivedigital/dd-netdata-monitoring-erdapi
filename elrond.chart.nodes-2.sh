...
DIMENSION current 'Current' absolute 1 1
DIMENSION synced 'Synced' absolute 1 1
CHART elrond.validatorblocks-node0 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 2)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.validatorblocks-node1 '' "Validator blocks signed/accepted" "Blocks" "Validator blocks" blocks area $((elrond_priority + 3)) $elrond_update_every
DIMENSION signedblocks 'Signed' absolute 1 1
DIMENSION signedaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node0 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 4)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.leaderblocks-node1 '' "Leader blocks proposed/accepted" "Blocks" "Leader blocks" blocks area $((elrond_priority + 5)) $elrond_update_every
DIMENSION leaderproposed 'Proposed' absolute 1 1
DIMENSION leaderaccepted 'Accepted' absolute 1 1
CHART elrond.rating-node0 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 6)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.rating-node1 '' "Current rating" "Rating" "Current rating" rating stacked $((elrond_priority + 7)) $elrond_update_every
DIMENSION rating 'Rating' absolute 1 1
CHART elrond.epoch-node0 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 8)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.epoch-node1 '' "Current epch" "Epoch" "Current epoch" epoch stacked $((elrond_priority + 9)) $elrond_update_every
DIMENSION epoch 'Epoch' absolute 1 1
CHART elrond.peers-node0 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 10)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.peers-node1 '' "Connected peers" "Connected peers" Peers peers stacked $((elrond_priority + 11)) $elrond_update_every
DIMENSION peers 'Peers' absolute 1 1
CHART elrond.validators_nodes-node0 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 12)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.validators_nodes-node1 '' "Connected validators/nodes" "Validators/Nodes" "Validators/Nodes" pvn area $((elrond_priority + 13)) $elrond_update_every
DIMENSION validators 'Validators' absolute 1 1
DIMENSION nodes 'Nodes' absolute 1 1
CHART elrond.num_leader-node0 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 14)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_leader-node1 '' "Num leader success/failure" "Leader success/failure" "Leader success/failure" lsf area $((elrond_priority + 15)) $elrond_update_every
DIMENSION leader_success 'Success' absolute 1 1
DIMENSION leader_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node0 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 16)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.num_validator-node1 '' "Num validator success/failure" "Validator success/failure" "Validator success/failure" vsf area $((elrond_priority + 17)) $elrond_update_every
DIMENSION validator_success 'Success' absolute 1 1
DIMENSION validator_failure 'Failure' absolute 1 1
CHART elrond.ignored_signatures-node0 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 18)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.ignored_signatures-node1 '' "Ignored signatures" "Signatures" "Ignored signatures" ignored_signatures stacked $((elrond_priority + 19)) $elrond_update_every
DIMENSION validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_num_leader-node0 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 20)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_leader-node1 '' "Total num leader success/failure" "Leader success/failure" "Total leader success/failure" tlsf area $((elrond_priority + 21)) $elrond_update_every
DIMENSION total_leader_success 'Success' absolute 1 1
DIMENSION total_leader_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node0 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 22)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_num_validator-node1 '' "Total num validator success/failure" "Validator success/failure" "Total vldt. success/failure" tvsf area $((elrond_priority + 23)) $elrond_update_every
DIMENSION total_validator_success 'Success' absolute 1 1
DIMENSION total_validator_failure 'Failure' absolute 1 1
CHART elrond.total_ignored_signatures-node0 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 24)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
CHART elrond.total_ignored_signatures-node1 '' "Total ignored signatures" "Signatures" "Total ignored signatures" "Total ignored signatures" stacked $((elrond_priority + 25)) $elrond_update_every
DIMENSION total_validator_ignored_signatures 'Ignored' absolute 1 1
EOF
